	...
	<script>
	  wx.ready(function(){
        ...
        var shareinfo={
             title: '你敢说自己的方言还标准？',
              desc: '录一段家乡话，让大家猜猜看！',
              link: 'http://szxytang.com/yin/za/voice2/',
              imgUrl: 'http://szxytang.com/yin/za/voice2/share.jpg'}
			  ...
			  success: function(res){
				...
				wx.uploadVoice({
				  ...
				  success: function (res){
					...
					alert('恭喜您上传成功！分享到朋友圈，让朋友听听你家乡的声音');
				//--------------------------------------------------	
					var a, b,id;
				...
				//--------------------------------------------------	
					...
					var sharenum = 1; 
					  ...
					  //分享  -- js格式
					var shareData = {
						title: "我是第<?php echo $guestsnum ?>位参加录音的,我这句方言能听懂的不超过5个",
						//desc: nickname+"的歌曲被分享了第"+ (sharenum++) +"次",
						desc: "录一段家乡话，让大家猜猜看！",
						//link: "http://szxytang.com/2014/wk_svn/voice/share.php?openid=<?php echo $userinfo_arr['openid']; ?>&mediaid="+voice.serverId,
						link: "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx461b5105da7629f1&redirect_uri=http://szxytang.com/yin/za/voice2/share.php?data="+ b +"&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect",
						imgUrl: "http://szxytang.com/yin/za/voice2/share.jpg"
					};
			  ...
			  //上传语音
				...
				//--------------------------------------------------	
					...
					var shareData = {
						...
						//link: "http://szxytang.com/2014/wk_svn/voice/share.php?openid=<?php echo $userinfo_arr['openid']; ?>&mediaid="+voice.serverId,
						link: "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx461b5105da7629f1&redirect_uri=http://szxytang.com/yin/za/voice2/share.php?data="+ b +"&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect",
						imgUrl: "http://szxytang.com/yin/za/voice2/img/s.jpg"
					};
					wx.onMenuShareAppMessage(shareData);
					wx.onMenuShareTimeline(shareData);
					wx.onMenuShareQQ(shareData);
