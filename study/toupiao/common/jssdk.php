...
class JSSDK {
  ...
  private $access_token_file = 'http://xyt.xy-tang.com/2016hj/wxwanda/toupiao/json/access_token.json';
  private $jsapi_ticket_file = 'http://xyt.xy-tang.com/2016hj/wxwanda/toupiao/json/jsapi_ticket.json';
