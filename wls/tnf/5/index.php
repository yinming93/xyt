...
<script src="../js/mod.js"></script>		
		...
		<section class="m-page m-page1">
			...
			<div class="m-img m-img01" style="background:url(static/img/1.jpg) center no-repeat;background-size:100% 100%">
       		...
       		<a href="http://szxytang.com/yin/wls/tnf/6/"><div style="width:75px;height:140px;background:;position: absolute;top:43%;left:22%;"></div></a>
       		<a href="http://szxytang.com/yin/wls/tnf/7/"><div style="width:75px;height:140px;background:;position: absolute;top:43%;left:55%;"></div></a>
