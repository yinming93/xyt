...
<!--首页导航结束-->
	...
	<section class="p-index" style="display:none;">
		...
		<a href="http://szxytang.com/2015n/hejunObj/xyt/?from=groupmessage&isappinstalled=0" style="position: absolute; top:98%; left:38%;  z-index:2000; color:black;">信玉堂技术支持</a>
		...
		<!-- 2 -->
		<section class="m-page m-page1">
			<div class="m-img m-img01" style="background:url(static/img/8.jpg) center no-repeat;background-size:100% 100%">
