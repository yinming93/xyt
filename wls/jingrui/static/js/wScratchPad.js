...
(function($)
{
	...
	{
		width		: 320,						// set width - best to match image width
		height		: 480,						// set height - best to match image height
		...
		init: function()
		{
			...
			else
			{
				if(this.settings.overlay != 'none')
				{
					...
					{
						this.drawImage(this.settings.image,this.settings.width,this.settings.height);
					}
