...
<script>
		...
		loadImages(['static/img/1.jpg','static/img/2.jpg','static/img/3.jpg','static/img/4.jpg','static/img/5.jpg','static/img/6.jpg','ccc.jpg',
...
<body onload="sy()">
	...
	<section class="p-index" style="display:none;">
		<!-- <a href="http://9e08a994a1bb.vxplo.cn/idea/yBR41EL"><p style="width:30%;position: absolute; top:97%;left:35%;z-index:2000; color:;text-align:center;">信玉堂技术支持</p></a> -->
		<!-- 1 -->
		...
		<section class="m-page m-page1">
			...
			<span id="ja" style="width:80%;height:50px;position:absolute;top:48%;left:10%;text-align:center;font-size:30px;background:transparent;border:0;">总转发数：<?php echo $nnna ?></span>
    ...
    <script>
        ...
        //在这里调用 API
            wx.onMenuShareAppMessage({
              title:  '我是第<?php echo $num ?>个为城市建设者送清凉的人，你加入吗？',
            ...
            title: '我是第<?php echo $num ?>个为城市建设者送清凉的人，你加入吗？', // 分享标题
