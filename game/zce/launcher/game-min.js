...
(function (b) {
	var c = function (b) {
		...
		a.prototype.push = function (d) {
			...
			-1 == l.indexOf(d) && (l.push(d), d.__recycle && d.__recycle(), this._length++,
...
(function (b) {
	...
	b.callLater = function (c, e) {
		for (var a = [], d = 2; d < arguments.length; d++)
			a[d - 2] = arguments[d];
	...
	var c = function (e) {
		...
		a.prototype._notifyListener = function (d) {
			...
			for (var a = a.concat(), e = 0; e < b; e++) {
				...
				if (d._isPropagationImmediateStopped)
					break
			}
...
(function (b) {
	var c = function (e) {
		...
		a.prototype.setTimeout = function (d, a, m) {
			for (var e = [], c = 3; c < arguments.length; c++)
				e[c - 3] = arguments[c];
...
(function (b) {
	...
	b.setTimeout = function (d, l, m) {
		for (var k = [], g = 3; g < arguments.length; g++)
			k[g - 3] = arguments[g];
		k = {
			listener : d,
			thisObject : l,
...
(function (b) {
	var c = function (e) {
		...
		function (d, a, b, e, c, f) {
			...
			q = this.d;
			if (1 != d || 0 != a || 0 != b || 1 != e)
				this.a = d * h + a * p, this.b = d * n + a * q, this.c = b * h + e * p, this.d = b * n + e * q;
...
(function (b) {
	var c = function (e) {
		...
		a.prototype.parserXML = function (d) {
			for (var a = 0; "\n" == d.charAt(a) || "\t" == d.charAt(a) || "\r" == d.charAt(a) || " " == d.charAt(a); )
				a++;
...
(function (b) {
	var c = function () {
		...
		e.getInstance = function (a, d) {
			...
			if (m)
				return m = new m, this.mapValueDic[l] = m, delete this.mapClassDic[l], m;
	...
	var c = function (e) {
		...
		a.prototype.drawCacheTexture = function (d) {
			...
			if (this._cacheDirty || null == this._texture_to_render || Math.round(a.width) != Math.round(this._texture_to_render._sourceWidth *
					m) || Math.round(a.height) != Math.round(this._texture_to_render._sourceHeight * m))
		...
		a.prototype._getConcatenatedMatrix = function () {
			for (var d = a.identityMatrixForGetConcatenated.identity(), l = this; null != l; ) {
				if (0 != l._anchorX || 0 != l._anchorY) {
					...
					d.prependTransform(l._x, l._y, l._scaleX, l._scaleY, l._rotation, l._skewX, l._skewY, l._anchorOffsetX, l._anchorOffsetY);
		...
		a.prototype.hitTest = function (d, a, m) {
			void 0 ===
			m && (m = !1);
			if (!this._visible || !m && !this._touchEnabled)
				return null;
		...
		a.prototype._getMatrix = function (d) {
			...
			e ? (d.append(e.a, e.b, e.c, e.d, e.tx, e.ty), d.append(1, 0, 0, 1,
					-a, -m)) : d.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, m);
			return d
		};
		a.prototype._getSize = function (d) {
			if (this._hasHeightSet && this._hasWidthSet)
				return this._clearSizeDirty(), d.initialize(0, 0, this._explicitWidth, this._explicitHeight);
			this._measureSize(d);
		...
		a.prototype._getOffsetPoint = function () {
			...
			if (0 != this._anchorX || 0 != this._anchorY)
				a = this._getSize(b.Rectangle.identity), d = this._anchorX * a.width, a = this._anchorY * a.height;
		...
		a.prototype.dispatchEvent = function (d) {
			if (!d._bubbles)
				return e.prototype.dispatchEvent.call(this, d);
			for (var a = [], b = this; b; )
		...
		a.prototype._dispatchPropagationEvent = function (d, a, b) {
			...
			f._notifyListener(d);
			if (!d._isPropagationStopped && !d._isPropagationImmediateStopped)
				for (e = 3, c = 1; c < b && (f = a[c], d._currentTarget = f, d._target = this, d._eventPhase = e, f._notifyListener(d),
						!d._isPropagationStopped && !d._isPropagationImmediateStopped); c++);
		};
		a.prototype.willTrigger = function (d) {
			for (var a = this; a; ) {
				if (a.hasEventListener(d))
					return !0;
				a = a._parent
			}
			return !1
...
(function (b) {
	var c = function (e) {
		...
		a.prototype._doAddChild = function (d, l, e) {
			...
			var c = d._parent;
			if (c == this)
				return this.doSetChildIndex(d, l), d;
			if (c) {
			...
			if (this._stage)
				for (d._onAddToStage(), l = a.__EVENT__ADD_TO_STAGE_LIST; 0 < l.length; )
					c = l.shift(), e && c.dispatchEventWith(b.Event.ADDED_TO_STAGE);
			d._setDirty();
			this._setSizeDirty();
			return d
		};
		...
		a.prototype.swapChildren = function (d, a) {
			...
			-1 == e || -1 == c ? b.Logger.fatalWithErrorId(1008) : this._swapChildrenAt(e, c)
		};
		...
		a.prototype.removeChildren = function () {
			for (var d = this._children.length - 1; 0 <= d; d--)
				this._doRemoveChild(d)
		};
		a.prototype._updateTransform = function () {
			if (this._visible) {
				...
				if (!this._cacheAsBitmap || !this._texture_to_render)
					for (var a = 0, m = this._children, c = m.length; a < c; a++)
						m[a]._updateTransform();
		...
		function (d) {
			if (!b.MainContext.__use_new_draw)
				for (var a = 0, e = this._children, c = e.length; a < c; a++)
					e[a]._draw(d)
		};
		a.prototype._measureBounds = function () {
		...
		a.prototype.hitTest = function (d, a, m) {
			...
			if (!this._visible)
				return null;
			if (this._scrollRect) {
				if (d < this._scrollRect.x || a < this._scrollRect.y || d > this._scrollRect.x + this._scrollRect.width || a > this._scrollRect.y + this._scrollRect.height)
					return null
			} else if (this.mask && (this.mask.x > d || d > this.mask.x + this.mask.width || this.mask.y > a || a > this.mask.y + this.mask.height))
				return null;
		...
		a.prototype._onAddToStage = function () {
			...
			for (var d = this._children.length, a = 0; a < d; a++)
				this._children[a]._onAddToStage()
		};
		a.prototype._onRemoveFromStage = function () {
			e.prototype._onRemoveFromStage.call(this);
			for (var d = this._children, a = d.length, b = 0; b < a; b++)
				d[b]._onRemoveFromStage()
		};
...
(function (b) {
	var c = function (e) {
		...
		a.prototype.hitTest = function (d, a, e) {
			...
			for (var g = e.length - 1; 0 <= g; g--) {
				...
				f = b.Matrix.transformCoords(f,
						d, a);
				if ((c = c.hitTest(f.x, f.y, !0)) && c._touchEnabled)
					return c
			}
			return this
		};
		...
		a.prototype._updateTransform = function () {
			for (var d = 0, a = this._children.length; d < a; d++)
...
(function (b) {
	var c = function (e) {
		...
		Object.defineProperty(a.prototype, "scrollLeft", {
			...
			set : function (d) {
				d != this._scrollLeft && (this._scrollLeft = d, this._validatePosition(!1,
			...
			if (!b || 0 != d || 0 != a)
				if (b || this._scrollTop != d || this._scrollLeft != a) {
					if (b) {
						...
						this._scrollTop = d, this._scrollLeft = a;
		...
		a.prototype._onTouchBeginCapture = function (d) {
			...
			if (a) {
				for (var e = d.target; e != this; ) {
					if ("_checkScrollPolicy" in e && (a = e._checkScrollPolicy()))
						return;
					e = e.parent
				}
				d.stopPropagation();
		...
		a.prototype.dispatchPropagationEvent = function (d) {
			for (var a = [], b = d._target, e = 0; b; )
				b == this && (e = a.length), a.push(b), b = b.parent;
			b = a.slice(0, e);
			b = b.reverse();
			a = b.concat(a);
			this._dispatchPropagationEvent(d, a,
		...
		a.prototype._moveAfterTouchEnd = function () {
			if (0 != this._velocitys.length) {
				for (var d = 0, b =
						0, e = 0, c = 0; c < this._velocitys.length; c++)
					var g = this._velocitys[c], f = a.weight[c], d = d + g.x * f, b = b + g.y * f, e = e + f;
		...
		a.prototype.getAnimationDatas = function (d, a, b) {
			...
			f = a + 500 * d;
			if (0 > f || f > b)
				for (f = a; Infinity != Math.abs(d) && 0.02 < Math.abs(d); )
					f += d, d = 0 > f || f > b ? 0.998 * d * 0.95 : 0.998 * d, c++;
			else
				c = 500 * -Math.log(0.02 / e);
			return {
			...
			if (g) {
				...
				if ("scale" == c.fillMode) {
					...
					if (n && f - n.width < b && h - n.height < e)
						a.drawScale9GridImage(d, c, n, b, e);
					else {
						var n = g._offsetX,
						p = g._offsetY,
						q = g._bitmapWidth || f,
					...
					a.drawRepeatImage(d, c, b, e, c.fillMode)
			}
		};
	...
	var c = function (e) {
		...
		a.prototype.changeToPassText = function (d) {
			if (this._displayAsPassword) {
				for (var a = "", b = 0, e = d.length; b < e; b++)
					switch (d.charAt(b)) {
					case "\n":
						a += "\n";
						break;
						...
						if (this._hasWidthSet)
							if (c + u <= this._explicitWidth)
								...
								for (var w = 0, v = 0, y = r[t], x = y.length; w < x; w++) {
									...
									if (c + u > this._explicitWidth && 0 != c + w)
										break;
									v += u;
									c += u
								}
			...
			if (0 != this._textMaxWidth) {
				...
				if (this._hasHeightSet)
					if (c < this._explicitHeight) {
						...
						c > this._explicitHeight && (f = Math.max(this._scrollV - 1, 0), f = Math.min(this._numLines - 1, f));
				g = Math.round(g);
				c = 0;
	...
	var c = function () {
		...
		b.prototype.addToResultArr = function (a) {
			if ("" != a) {
				...
				d.push(["&apos;;", "'"]);
				for (var b = 0; b < d.length; b++)
					a.replace(new RegExp(d[b][0], "g"), d[b][1]);
...
(function (b) {
	var c = function (e) {
		...
		a.prototype._getFrameLabelByName = function (d, a) {
			...
			if (b)
				for (var e = null, c = 0; c < b.length; c++)
					if (e = b[c], a ? e.name.toLowerCase() === d : e.name === d)
						return e;
			return null
		};
		...
		a.prototype._gotoFrame = function (d) {
			var a;
			if ("string" === typeof d)
				a = this._getFrameLabelByName(d).frame;
			else if (a = parseInt(d + "", 10), a != d)
		...
		a.prototype.setPlayTimes = function (d) {
			if (0 > d || 1 <= d)
				this._playTimes = 0 > d ? -1 : Math.floor(d)
		};
...
(function (b) {
	var c = function (e) {
		...
		a.prototype.onTouchEnd = function (a, e, c) {
			var k = this.touchingIdentifiers.indexOf(c);
			-1 != k && (this.touchingIdentifiers.splice(k, 1), k = b.MainContext.instance.stage.hitTest(a, e)) && (a = this.getTouchData(c, a, e), delete this.touchDownTarget[c], c = a.beginTarget, a.target = k, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), c == k ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP,
...
(function (b) {
	var c = function (e) {
		...
		a.prototype.$ = function (d) {
			var e = document;
			if (d = d instanceof HTMLElement ? d : e.querySelector(d))
				d.find = d.find || this.$, d.hasClass = d.hasClass || function (a) {
...
(function (b) {
	var c = function () {
		...
		e.parseNode = function (a) {
			...
			c = b.length;
			for (k = 0; k < c; k++)
				if (g = e.parseNode(b[k]))
					d.children || (d.children = []), g.parent = d, d.children.push(g);
		...
		e.findByPath = function (a, d, b) {
			var c = d.indexOf("."),
			k;
			-1 == c ? (k = d, c = !0) : (k = d.substring(0, c), d = d.substring(c + 1), c = !1);
			if (a = a.children)
		...
		e.getAttributes = function (a, d) {
			d ? d.length = 0 : d = [];
			for (var b in a)
				"$" == b.charAt(0) && d.push(b.substring(1));
			return d
		};
		return e
	}
...
(function (b) {
	...
	var e = function () {
		...
		a.prototype.readBytes = function (d, b, e) {
			...
			else if (!this.validate(e))
				return null;
			d ? d.validateBuffer(e) : d = new a(new ArrayBuffer(e));
			for (var c =
					0; c < e; c++)
				d.data.setUint8(c + b, this.data.getUint8(this.position++))
		};
		...
		function (a, b, e) {
			...
			if (!(0 > b || 0 > e) && (e = 0 == e ? a.length - b : Math.min(a.length - b, e), 0 < e)) {
				...
				for (var c = b; c < e + b; c++)
					this.data.setUint8(this.position++, a.getUint8(c))
			}
		};
		...
		function (a, b) {
			...
			for (var e = 0; e < a.length; e++)
				this.data.setUint8(this.position++, a[e])
		};
		...
		function (a) {
			for (var b = 0, e = "", c, g = 0, f = 0, h = 0, n = 0; a.length > b; ) {
				c = a[b++];
				if (c === this.EOF_byte)
					c = 0 !== f ? this.decoderError(!1) : this.EOF_code_point;
				else if (0 === f)
					this.inRange(c, 0, 127) || (this.inRange(c, 194, 223) ? (f = 1, n = 128, g = c - 192) : this.inRange(c, 224, 239) ? (f = 2, n = 2048, g = c - 224) : this.inRange(c, 240, 244) ? (f = 3, n = 65536, g = c - 240) : this.decoderError(!1), g *= Math.pow(64, f), c = null);
				else if (this.inRange(c, 128, 191))
					if (h += 1, g += (c - 128) * Math.pow(64, f - h), h !== f)
						c = null;
					else {
						var p = g,
						q = n,
					...
					n = h = f = g = 0, b--, c = this.decoderError(!1, c);
...
(function (b) {
	var c = function (e) {
		...
		a.removeTweens = function (d) {
			if (d.tween_count) {
				for (var b =
					...
					b[e]._target == d && (b[e].paused = !0, b.splice(e, 1));
				d.tween_count = 0
			}
		};
		a.pauseTweens = function (a) {
			if (a.tween_count)
				for (var e = b.Tween._tweens, c = e.length - 1; 0 <= c; c--)
					e[c]._target == a && (e[c].paused = !0)
		};
		a.resumeTweens = function (a) {
			if (a.tween_count)
				for (var e = b.Tween._tweens, c = e.length - 1; 0 <= c; c--)
					e[c]._target == a && (e[c].paused = !1)
		};
		a.tick = function (d, b) {
			void 0 === b && (b = !1);
		...
		a._register = function (d, e) {
			...
			k = a._tweens;
			if (e)
				c && (c.tween_count = 0 < c.tween_count ? c.tween_count + 1 : 1), k.push(d), a._inited || (b.Ticker.getInstance().register(a.tick, null), a._inited = !0);
			else
		...
		a.prototype._updateTargetProps = function (d, b) {
			...
			if (d || 1 != b) {
				...
				this.passive = !1, e = c = this._curQueueProps;
		...
		a.prototype._appendQueueProps = function (d) {
			...
			for (h in d) {
				...
				if (b = a._plugins[h])
					for (f = f || {}, c = 0, g = b.length; c < g; c++)
						b[c].step && b[c].step(this, h, e, d[h], f);
...
(function (b) {
	...
	b.setItem = function (b, e) {
		try {
			...
			return egret.Logger.infoWithErrorId(1018, b, e),
			!1
		}
	};
	b.removeItem = function (b) {
	...
	var c = function (e) {
		...
		a.prototype.drawRepeatImage = function (a, e, c, k, g, f, h, n, p, q) {
			if (void 0 === a.pattern) {
				...
				t = a._bitmapData,
				s = t;
				if (t.width != k || t.height != g || 1 != r)
					s = document.createElement("canvas"), s.width = k * r, s.height = g * r, s.getContext("2d").drawImage(t, e, c, k, g, 0, 0, k * r, g * r);
...
(function (b) {
	var c = function (e) {
		function a(a) {
			...
			for (var c = 0, m = 0; c < a; c += 6, m += 4)
				this.indices[c + 0] = m + 0, this.indices[c + 1] = m + 1, this.indices[c + 2] = m + 2, this.indices[c + 3] = m + 0, this.indices[c + 4] = m + 2, this.indices[c + 5] = m + 3;
			this.initWebGL();
		...
		a.prototype.initAll = function () {
			a.isInit || (a.isInit = !0, egret_webgl_graphics.init(),
				...
				if (0 == k.width || 0 == k.height || e && (0 == e.width || 0 == e.height))
					return !1;
				...
				if (a instanceof b.DisplayObjectContainer)
					for (f = a._children, n = 0, p = f.length; n < p; n++)
						f[n]._updateTransform();
		...
		a.prototype.drawImage = function (a, b, e, c, g, f, h, n, p, q) {
			...
			if (!this.contextLost)
				if (void 0 !== q)
					this.drawRepeatImage(a, b, e, c, g, f, h, n, p, q);
				else {
					this.createWebGLTexture(a);
					q = a._bitmapData.webGLTexture[this.glID];
					if (q !== this.currentBaseTexture || this.currentBatchSize >= this.size - 1)
						this._draw(),
	...
	var c = function () {
		...
		e.prototype.init = function () {
			...
			for (var e in this.uniforms)
				this.uniforms[e].uniformLocation = a.getUniformLocation(d, e);
			this.initUniforms();
			this.program = d
		};
...
(function (b) {
	var c = function (e) {
		...
		a.prototype.proceed = function (a) {
			function e() {
				if (4 == k.readyState)
					if (k.status != a._status && (a._status = k.status, b.HTTPStatusEvent.dispatchHTTPStatusEvent(a, k.status)), 400 <= k.status || 0 == k.status)
	...
	var c = function (e) {
		...
		a.prototype.addTouchListener = function () {
			...
			this.rootDiv.addEventListener("touchstart", function (b) {
				for (var e = b.changedTouches.length, c = 0; c < e; c++)
...
(function (b) {
	var c = function () {
		...
		e.prototype.createGroup = function (a, b, e) {
			void 0 === e && (e = !1);
			if (!e && this.groupDic[a] || !b || 0 == b.length)
				return !1;
			e = this.groupDic;
				...
				if (e = a.groups)
					for (c = e.length, k = 0; k < c; k++) {
						for (var f = e[k], h = [], n = f.keys.split(","),
							p = n.length, q = 0; q < p; q++)
							g = n[q].trim(), (g = this.keyMap[g]) && -1 == h.indexOf(g) && h.push(g);
		...
		a.prototype.loadGroup = function (a, e, c) {
			...
			if (!this.itemListDic[e] && e)
				if (a && 0 != a.length) {
					...
					egret.Logger.warningWithErrorId(2001, e), a = new b.ResourceEvent(b.ResourceEvent.GROUP_LOAD_ERROR), a.groupName = e, this.dispatchEvent(a)
		};
	...
	var c = function (e) {
		...
		a.prototype.destroyRes = function (a) {
			...
			if (b) {
				...
				for (var e in b._textureMap)
					this.textureMap[e] && delete this.textureMap[e];
				return !0
			}
			return !1
		};
...
(function (b) {
	var c = function (b) {
		...
		a.prototype.getTexturePath = function (a, b) {
			...
			c = b.split("\n")[2],
			g = c.indexOf('file="');
			-1 != g && (c = c.substring(g + 6), g = c.indexOf('"'), e = c.substring(0, g));
			a = a.split("\\").join("/");
			g = a.lastIndexOf("/");
...
var __extends = this.__extends || function (b, c) {
	...
	c.prototype.onTouchPlayHandler = function (b) {
		...
		this.__appTimer = new egret.Timer(100);
...
(function (b) {
	var c = function () {
		...
		e.prototype.createSprite = function (a, d, c) {
			...
			a = new b.SwfSprite;
			for (var m = c.length, k, g, f = 0; f < m; f++)
				k = c[f], g = this._createDisplayFuns[k[1]], null != g && (g = g.apply(this, [k[0], k]), g.name = k[9], g.x = k[2], g.y = k[3], k[1] != e.dataKey_Scale9 && k[1] != e.dataKey_ShapeImg && (g.scaleX = k[4], g.scaleY = k[5]), g.skewX = k[6], g.skewY = k[7], g.alpha = k[8], a.addChild(g));
		...
		e.prototype.createMovie = function (a, d) {
			...
			for (p in m) {
				...
				g = null == k[p] ? [] : k[p];
				for (var q = 0; q < h; q++)
					n = this._createDisplayFuns[f], null != n && g.push(n.apply(this, [p, null]));
				k[p] = g
			}
...
var __extends = this.__extends || function (b, c) {
	...
	c.prototype.createScene = function () {
		...
		for (var b = Math.ceil(App.stage.stageHeight / this.disHeight) + 5, a = 0; a < b; a++)
			this.addPlatform(), this.addCloud()
	};
...
(function (b) {
	var c = function (c) {
		...
		a.prototype.update = function () {
			if (this._isPlay)
				if (this._currentFrame > this._endFrame) {
					...
					this.setCurrentFrame(this._currentFrame), this._currentFrame += 1
		};
		...
		a.prototype.labels = function () {
			for (var a = this._labels.length, b = [], c = 0; c < a; c++)
				b.push(this._labels[c][0]);
			return b
		};
...
var __extends = this.__extends || function (b, c) {
	...
	c.prototype.onTouchHandler = function (b) {
		...
		App.ClickMore() : this.gameOverPanel && b.currentTarget == this.gameOverPanel.btn_again ? (document.getElementById("toolbar").style.display="none",this.start()) : this.gameStartPanel && b.currentTarget == this.gameStartPanel.btn_play && this.start()
	};
	return c
}
(App);
	...
	var c = function () {
		...
		b.prototype.createBitmap = function (a) {
			...
			for (c in this._sheets)
				if (b = this._sheets[c], b = b.getTexture(a), null != b)
					break;
	...
	var c = function () {
		...
		b.prototype.updateAdd = function () {
			for (var a = this._addQueue.length, b, c, e = 0; e <
				a; e++)
				c = this._addQueue.pop(), b = this._animations.indexOf(c), -1 == b && this._animations.push(c)
		};
		b.prototype.updateRemove = function () {
			for (var a = this._removeQueue.length, b, c = 0; c < a; c++)
				b = this._removeQueue.pop(), b = this._animations.indexOf(b), -1 != b && this._animations.splice(b, 1)
		};
