! function (e, t) {
    e("data/jigsawGame", function (e, t, n) {
        n.exports = [{
            ...
            ka: [
                ...
                },
                {
                    desc: "2",
                    id: "2",
                    first: "\u5927\u795e\u4f60\u662f\u6211\u7684\u5076\u50cf",//大神你是我的偶像
                    second: "\u8fd8\u6709\u4e00\u4e9b\u8981\u6311\u6218\u7684\u54e6!",//还有一些要挑战的哦
                    pic: [{
                        img: "./images/1.jpg",
                        row: 3,
                        type: 2,
        ...
        var i = e("underscore"),
            o = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame ||
        ...
        function r(e, t) {
            var n = this;
            t = t || {}, n.itemQuery = t.itemQuery || "[dragitem='1']", n.dragOut = t.dragOut || !1, n.layer = e, s.extend(
                n, o()), n.init()
        }
        ...
        r.prototype.init = function () {
            ...
            var n = this,
                ...
                r = n.layer;
            c ? (a(r, "touchstart", n), a(t, "orientationchange", n)) : u ? a(r, "MSPointerDown", n) : (a(r,
                "mousedown", n), a(t, "resize", n))
        }, r.prototype.initWinEvent = function (e) {
            var n = this,
                a = e ? g.addEvent : g.removeEvent;
            c ? (a(t, "touchmove", n), a(t, "touchend", n), a(t, "touchcancel", n)) : u ? (a(t, "MsPointerMove", n), a(
                t, "MsPointerUp", n), a(t, "MsPointerCancel", n)) : (a(t, "mousemove", n), a(t, "mouseup", n))
            ...
            if (a) {
                t.currentElement = a, t.currentDestElement = a, t._pushToOuter(t.currentElement), t.touchStartX = n.pageX,
                    t.touchStartY = n.pageY;
                var r = JSON.parse(t.currentElement.getAttribute("position"));
                r.display = "", t.startX = t.x = parseInt(r.left), t.startY = t.y = parseInt(r.top), t.layerWidth =
                    parseInt(parseInt(r.width)), t.layerHeight = parseInt(parseInt(r.height)), i(t.moveLayer, t.moveCssText
                    .css(r)), t.initWinEvent(!0), t.trigger("drag", t.currentElement), g.stopEvent(e)
            }
            ...
            if (t.currentElement) {
                ...
                t.currentDestElement && t.currentDestElement != t.currentElement ? (t.currentDestElement.parentNode.replaceChild(
                    n, t.currentDestElement), t.currentElement.parentNode.replaceChild(t.currentDestElement, t.currentElement),
                    t.refresh()) : (t.currentElement.parentNode.replaceChild(n, t.currentElement), a = "nochange"), t.currentElement = !
                    1, t.currentDestElement = !1, t.initWinEvent(!1), t.refresh(), t.trigger(a)
            ...
            var t = this;
            t.moveLayer || (t.moveLayer = document.createElement("div"), t.moveLayer.className = "drag-float", t.moveCssText =
                l("display:none;position:absolute;top:0px;left:0px;"), i(t.moveLayer, t.moveCssText), document.body.appendChild(
                t.moveLayer));
            var n = e.cloneNode(!0);
        ...
        i.extend(l.prototype, o()), l.prototype.init = function (e) {
            ...
            n.timer.on("count", function (e) {
                2 == n.config.type && (e = 1e3 * n.config.second - e, 0 >= e && (n.trigger("timeout"), n.stop(), e = 0)),
                    i.html(u.getShowTime(e));
                //alert(i.html());此处为动态的剩余描述显示 lzj
            ...
            n.dom.delegate(".playbtn", "click", function () {
                ...
                n.play(), n.trigger("playStart"), o.removeClass("down"), o.find("ul").removeClass("playanmal"), n.gameState =
                    3
            }), n.on("ready", function () {
        ...
        var a = e("module/model"),
            ...
            i = function () {
                var e = {}, t = function () {
                    return e.div || (e.div = document.createElement("div"), e.div.style.cssText =
                        "-ms-touch-action: none;z-index:1;position:absolute;left:0px;top:0px;width:100%;height:100%;background-color:#000;opacity:.6;display:none;",
                        document.body.appendChild(e.div)), e.div
                };
        ...
        n.exports = function (e) {
            ...
            var c = ["touchmove", "MSPointerMove", "MSPointerUp", "MSPointerDown", "click"],
                u = function () {
                    if (s._layer = document.createElement("div"), s._layer.style.cssText =
                        "-ms-touch-action: none;position:absolute;left:0px;top:0px;display:none;z-index:" + t.zIndex,
                        document.body.appendChild(s._layer), t.html && (s._layer.innerHTML = t.html), t.preventDefault &&
        ...
        var r = e("underscore"),
            ...
            c = e("ui/dom"),
            u =
                '<div class="dialog"><div class="content"><div class="message"><%=message%></div><h1></h1><div class="dig-btns"><%if(calcelTxt){%><span class="dig-btn cancel"><%=calcelTxt%></span><%}%><%if(sureTxt){%><span class="dig-btn sure"><%=sureTxt%></span><%}%></div></div></div>',
            g = null;
        ...
        function r(e) {
            ...
            p.dom.find(".kapics").html("第(" + (p.currentGame.pic + 1) + "/" + n.pic.length + ")关，本关限时 " + r.second +
                " 秒"), u.set(f, p.currentGame), p.jigsawGame.setConfig(r)
        ...
        p.init = function (e) {
            ...
            e.html(t), p.jigsawGame = s, p.jigsawGame.init(e), p.dom = e, p.jigsawGame.on("picOver", function (e) {
                //e为每一关耗时对象 add by lzj
                //console.dir("e=" + e);
                totalMillSeconds = totalMillSeconds + e;
                //console.dir("totalMillSeconds=" + totalMillSeconds);
                //dp_submitScore(p.currentGame.pic + 1);
                var str = "恭喜您挑战成功，共闯过了<em>" + (p.currentGame.pic + 1) + "</em>关";
                if (!p.hasNextPic()) {
                    var seconds = totalMillSeconds / 1000;
                    //showAllResult("恭喜你完成所有挑战！总共用时（<em>" + seconds + "</em>）秒！");
                    showAllResult("<em>" + seconds + "</em>");
                }
                else {
            ...
            $('#tijiao').click(function () {
                // 提交信息
                if (isCheckOk()) {
                    var score = totalMillSeconds / 1000;
					
                    var name = document.getElementById('txtName').value;
					var tel  = document.getElementById('txtTel').value;
					
					alert('本次活动已结束，谢谢参与！')
					/* var datadb = "name="+name+"&tel="+tel+"&score="+score;

					$.post("add.php",datadb,function(res){
					
						if(res=='ok'){
							alert("恭喜您，提交成绩成功！");
							window.location.href="paiming.php";
						}else{
							alert("提交成绩失败，请稍后再试！");
						}
					}); */
        ...
        p.saveUserScore = function (e) {
            ...
            !e || 0 == e.ka && 0 == e.pic ? (p.dom.find(".play-info").show().find(".first-guide").html(
                "\u4ea4\u6362\u56fe\u7247\uff0c\u5b8c\u6210\u62fc\u56fe").show(), e = {
                    type: c[0].type,
                    ka: 0,
                    pic: 0
        ...
        p.showNextKa = function () {
            ...
            (p.dom.find(".first-guide").html("\u606d\u559c\u4f60\uff0c\u5b8c\u6210\u62fc\u56fe"), p.dom.find(
                ".play-info").show().find(".playing-over").show())
            if (p.hasNextPic()) {
                //p.do
            } else { }
            ...
            var e = p.currentGame.ka,
                ...
                i = n.ka,
                o = n.ka[e].pic;
            return t + 1 >= o.length ? (e++, t = 0) : t++, e >= i.length ? void p.showTongguan() : (p.currentGame.ka =
                e, p.currentGame.pic = t, r(p.currentGame), void p.dom.find(".play-info").hide().find(".playing-over").hide())
        }, n.exports = p
        ...
        function a(e, t, n) {
            var a = "page-anmi",
                ...
                i = "",
                s = "";
            a += " page-anmi-" + n + "-cur", r += " page-anmi-" + n + "-out", i = "cur-page-" + n, s = "out-page-" + n,
                e.addClass(a), t.addClass(r), t.show(), o.nextFrame(function () {
...
// add by lzj 20150501 begin
//通关后显示的最终结果界面
function showAllResult(str) {
    $('#allPassed .resultinfo').html(str);
    $('#writeInfo').show();
    $('.mask').show();
    $('#allPassed').show();
}
...
function isCheckOk() {
    ...
    if ($("#txtTel").val().trim() != "") {
        var express = "^1[3-9][0-9]{9}$";
        var validate = $("#txtTel").val().trim().toString().match(express);
        if (validate == null) {
            alert('电话输入不正确哦~');
            return false;
        }
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.indexOf("ok") >= 0) {
                ...
                alert("恭喜您提交成功！");
                //hideSubmitPage();
                //var str = "好刺激，继续挑战~<br />再玩一次可能会更快哦~";
                //GoOnChallenge(str);
            }
            else {
                console.log("出错了：" + msg);
