...
var t = {
        ...
        _X: function (T, М, Τ, O, I, Η) {
            //绘制倒计时
            T.drawImage(М.img, М.x, М.y, М.w, М.h, Τ + М.ox >> 0, O + М.oy-50 >> 0, I || М.w, Η || М.h)
        },
        oϹ: function (О, Ο) {
            var W = new Image();
            var z = О.length;
...
var p = [
        {
            id: "bg",
            src: "res/img/mainbg.jpg"
        },
        {
            id: "title",
            src: "res/img/title.png"
        },
        {
            id: "help",
            src: "res/img/help.png"
        },
        {
            id: "number",
            src: "res/img/icons.png"
        },
        {
            id: "phone-0",
            src: "res/img/b2.png"
        ...
        {
            id: "bg3",
            src: "res/img/mainbg-2.jpg"
        },
        {
            id: "startbtn",
            src: "res/img/start.png"
        },
        {
            id: "restartbtn",
            src: "res/img/restart.png"
        }
    ];
(function () {
...
(function (exports, undefined) {
    ...
    Player.prototype = {
        ...
        resize: function () {
            ...
            if (!Player.N0) {
                //var Α = Player.N0 = t.ІJ(this.width, this.height, 0, null, 4, "rgba(255,255,90,0.8)");
                var Α = t.ІJ(this.width, this.height, 0, null, 4, "rgba(255,255,90,0.8)");
                //Player.N0 = ResourcePool.get("wind");
                var F = Α.getContext("2d");
                this.ox = -Α.width >> 1;
                this.oy = -Α.height >> 1;
                F.fillStyle = "rgba(255,255,90,0.8)";
                F.fillRect(-this.ox - 40, -this.oy - 2, 80, 4);
                F.fillRect(-this.ox - 2, -this.oy - 0, 4, 80)
            }
            this.N0 = ResourcePool.get("wind");
            this.ox = -this.N0.width >> 1;
            this.oy = -this.N0.height >> 1;
            if (!Player.Ϲ1) {
                var Α = Player.Ϲ1 = t.ІJ(95, 95, 50, "rgba(0,0,0,0.3)");
                var F = Α.getContext("2d");
                var О = ResourcePool.get("camera");
                //绘制相机
                F.drawImage(О, Α.width - О.width >> 1, Α.height - О.height)
            }
            this.Ϲ1 = Player.Ϲ1;
        ...
        PΝ: function (О, x, m) {
            ...
            О.drawImage(this.N0, this.x + this.ox, this.y + this.oy + 50);
            //绘制相机按钮背景
            О.drawImage(this.Ϲ1, this.ZР.width - this.Ϲ1.width >> 1, this.ΟΤ + 50);
            if (this.OA) {
                if (this.Ε4) {
                    this.Ε4.PΝ(О, x, m)
                }
                ...
                О.fillStyle = "#fff";
                О.fillRect(this.x + this.ox, this.y + this.oy - 20, this.width, this.height);
                О.globalAlpha = 1
            }
        }
    }
...
(function (exports, undefined) {
    ...
    Photo.prototype = {
        ...
        PΝ: function (T, I, Τ) {
            ...
            T.fillRect(this.ox-2, this.oy-2 -260, this.width+4, this.height+4);
            T.fillStyle = "rgba(255,255,255,1)";
            T.fillRect(this.ox, this.oy - 260, this.width, this.height);
            //合成一张照片
            T.drawImage(this.canvas, this.ox + this.borderWidth, this.oy + this.borderWidth- 260, this.width - this.borderWidth * 2, this.height - this.borderWidth * 2);
            T.restore();
            var Ϲ = this.k6.toFixed(2) + "分";
            //绘制分数
            var Р = t.DN(T, Ϲ, this.ΤR, this.x-110, this.y-10);
            document.getElementById("guanzhu").style.display = "block";
            stitle = "我拍尔康得了" +this.k6.toFixed(2) +"分，快来挑战我！";
            setShare();
			//dp_submitScore();
            var code = this.k6.toFixed(2);
            // if (code>97) {
...
var A = Best.hg.extend({
        ...
        Ϻ: function (Β) {
            ...
            //使用图片按钮
            this.Κe = ResourcePool.get("startbtn");
            //这里禁用文字按钮
            //this.Аp() 
        },
        resize: function () {
        ...
        PΝ: function (Β, Ϝ, І) {
            ...
            Β.fillRect(0, 0, this.width, this.height);
            Β.globalAlpha = 0.7 + Math.sin(І / 400) * 0.3;
            //开始拍按钮
            Β.drawImage(this.Κe, (this.width - this.Κe.width)/2*1, U+550);
            Β.globalAlpha = 0.95;
            var U = (this.height - this.Zl.height >> 1) - 100;
            //描绘首屏图案
            Β.drawImage(this.Zl, 0, (this.height - this.Zl.height)/2*0.72);
            Β.globalAlpha = 1
        },
        Аi: function () {
            var W = this;
...
var Н = Best.hg.extend({
        ...
        cF: function () {
            ...
            if (this.x7) {
                this.zЅ = this.Oj;
                this.C9 = String(Math.ceil(this.zЅ / 500));
                this.МЅ = true;
                this.Qi = 0
            }
            this.dΜ = null;
        ...
        ΗZ: function (V, Ρ, O) {
            ...
            //画游戏介绍
            document.getElementById('dabai').style.display = 'none';
            document.getElementById('container').style.backgroundImage = 'url(res/img/mainbg.jpg)';
...
var M = Best.hg.extend({
        ...
        uf: function () {
            if (!M.ng) {
                var q = M.ng = t.ІJ(500, 280, 50, "rgba(255,255,255,0)");
        ...
        hA: function () {
            if (!M.cΑ) {
                var w = "再 拍 一 次";
                var Η = 40;
                var m = t.ІJ(280, 100, 30, "rgba(255,255,255,0)");
                M.cΑ = ResourcePool.get("restartbtn")
        ...
        resize: function () {
            ...
            this.cТ = t.cЕ(this.cΑ, this.width - this.cΑ.width >> 1, (this.height - this.cΑ.height)*0.95);
        },
        cF: function () {
            this.Β8 = 0;
            this.iΥ = false;
