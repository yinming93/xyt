(function(e) {
    function t() {
        function t() {
            var e = R.createImage("../addons/lonaking_niulangfly/template/mobile/images/t01f169fa7fdd166976.png"),
            t = e.width,
            n = e.height;
    ...
    c,
    h = {
        loadImg: ["../addons/lonaking_niulangfly/template/mobile/images/t01f169fa7fdd166976.png", "../addons/lonaking_niulangfly/template/mobile/images/t01e0bea40de12d9b5d.jpg"],
        gameImg: ["../addons/lonaking_niulangfly/template/mobile/images/t0105cf5ddc2788b36d.png", "../addons/lonaking_niulangfly/template/mobile/images/t01bc27fb7566f32662.png", "../addons/lonaking_niulangfly/template/mobile/images/t01bf2f5503de2c09c0.png", "../addons/lonaking_niulangfly/template/mobile/images/t01d5a6f27dfd6f0a29.png", "../addons/lonaking_niulangfly/template/mobile/images/t0180d607c54cbc42bb.png", "../addons/lonaking_niulangfly/template/mobile/images/t0112104234e3d91aa4.png"]
    },
    p = function() {
        function t() {
            var t = Math.random(),
    ...
    d = function() {
        ...
        return n.init = function() {
            ...
            n.lastY,
            n.status = !0,
            n.model = R.createImage("../addons/lonaking_niulangfly/template/mobile/images/t0105cf5ddc2788b36d.png"),
            n.model2 = R.createImage("../addons/lonaking_niulangfly/template/mobile/images/t01bc27fb7566f32662.png"),
    ...
    v = function() {
        function e(e) {
            ...
            var t = ["../addons/lonaking_niulangfly/template/mobile/images/t01bf2f5503de2c09c0.png", "../addons/lonaking_niulangfly/template/mobile/images/t01d5a6f27dfd6f0a29.png"];
        ...
        r = {
            ...
            showScore: function() {
                ...
                r.find(".tips span").html(n),
               	(n < 177 && n > 76 )? alert('赶紧提交分数吧！') : ((n < 277 && n > 176) ? alert('赶紧提交分数吧！') : ( n>276 ? alert('赶紧提交分数吧！') : alert('赶紧提交分数吧！')))
                document.cookie="code1="+n;
            },
            wxHide: function() {
    ...
    y = function() {
        ...
        i = {
            ...
            showDefault: function(t) {
                var r = ["../addons/lonaking_niulangfly/template/mobile/images/logo.png", "../addons/lonaking_niulangfly/template/mobile/images/logo.png"],
                i;
                t %= r.length,
                e("#prizeResult").hide(),
                n.show().find(".prize-default").show().find(".random-prize").attr("src", r[t]),
                i = n.find(".prize-default .share").attr("data-desc").split("|"),
                n.find(".prize-default .share").data("desc", i[t % i.length])
            },
            showPrize: function(t, i) {
                ...
                u;
                t = (3 - t) % s.length,
                n.show().find(".prize-default").hide(),
                e("#prizeResult").show().find(".prize-content").find("p span").html(o[t]).end().find("img").attr("src", s[t]).end().find(".yards span").html(i),
                e("#prizeResult .scroll-rst").removeAttr("style"),
                r ? r.scrollTo(0, 0) : r = new IScroll("#prizeResult")
            }
        };
        return i
    } ();
    ...
    var b = new Best.Game({
        ...
        score: 0,
        time: 0,
        bgImg: R.createImage("../addons/lonaking_niulangfly/template/mobile/images/t01f169fa7fdd166976.png"),
        bgScrollTime: 0,
