...
var Zepto = function() {
    ...
    function X(n, i, r) {
        for (e in i) r && (_(i[e]) || M(i[e])) ? (_(i[e]) && !_(n[e]) && (n[e] = {}), M(i[e]) && !M(n[e]) && (n[e] = []), X(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
    }
    function V(t, e) {
    ...
    S.fragment = function(e, i, r) {
        ...
        s || (e.replace && (e = e.replace(p, "<$1></$2>")), i === t && (i = l.test(e) && RegExp.$1), i in x || (i = "*"), f = x[i], f.innerHTML = "" + e, s = n.each(o.call(f.childNodes),
        function() {
            f.removeChild(this)
        })),
        _(r) && (u = n(s), n.each(r,
    ...
    S.qsa = function(t, e) {
        ...
        s = i || r ? e.slice(1) : e,
        a = E.test(s);
        return A(t) && a && i ? (n = t.getElementById(s)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : o.call(a && !i ? r ? t.getElementsByClassName(s) : t.getElementsByTagName(e) : t.querySelectorAll(e))
    },
    ...
    n.fn = {
        ...
        ready: function(t) {
            return b.test(a.readyState) && a.body ? t(n) : a.addEventListener("DOMContentLoaded",
            function() {
                t(n)
            },
            !1),
        ...
        closest: function(t, e) {
            var i = this[0],
            r = !1;
            for ("object" == typeof t && (r = n(t)); i && !(r ? r.indexOf(i) >= 0 : S.matches(i, t));) i = i !== e && !A(i) && i.parentNode;
            return n(i)
        },
        parents: function(t) {
        ...
        attr: function(n, i) {
            ...
            return "string" == typeof n && i === t ? this.length && 1 === this[0].nodeType ? !(r = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : r: t: this.each(function(t) {
                if (1 === this.nodeType) if ($(n)) for (e in n) B(this, e, n[e]);
        ...
        css: function(t, i) {
            ...
            var a = "";
            if ("string" == L(t)) i || 0 === i ? a = q(t) + ":" + I(t, i) : this.each(function() {
    ...
    ["width", "height"].forEach(function(e) {
        ...
        n.fn[e] = function(r) {
            var o, s = this[0];
            return r === t ? D(s) ? s["inner" + i] : A(s) ? s.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function(t) {
                s = n(this),
                s.css(e, Y(this, r, t, s[e]()))
            })
        }
    }),
    v.forEach(function(t, e) {
        ...
        n.fn[t] = function() {
            ...
            return r.length < 1 ? this: this.each(function(t, u) {
                ...
                var f = a.documentElement.contains(o);
...
function(t) {
    ...
    function T(e, i) {
        ...
        function(t, n) {
            ...
            e[n] = x
        }), (i.defaultPrevented !== n ? i.defaultPrevented: "returnValue" in i ? i.returnValue === !1 : i.getPreventDefault && i.getPreventDefault()) && (e.isDefaultPrevented = w)),
        e
    }
    function j(t) {
        var e, i = {
    ...
    t.fn.trigger = function(e, n) {
        return e = o(e) || t.isPlainObject(e) ? t.Event(e) : T(e),
        e._args = n,
        this.each(function() {
...
function(t) {
    ...
    function E(e) {
        ...
        !e.data || e.type && "GET" != e.type.toUpperCase() || (e.url = b(e.url, e.data), e.data = void 0)
    }
    function T(e, n, i, r) {
    ...
    t.ajax = function(e) {
        ...
        E(n),
        n.cache === !1 && (n.url = b(n.url, "_=" + Date.now()));
        var s = n.dataType,
        a = /\?.+=\?/.test(n.url);
        if ("jsonp" == s || a) return a || (n.url = b(n.url, n.jsonp ? n.jsonp + "=?": n.jsonp === !1 ? "": "callback=?")),
        t.ajaxJSONP(n, o);
        var T, u = n.accepts[s],
        f = {},
        l = function(t, e) {
        ...
        if (d.setRequestHeader = l, d.onreadystatechange = function() {
            if (4 == d.readyState) {
                ...
                if (d.status >= 200 && d.status < 300 || 304 == d.status || 0 == d.status && "file:" == h) {
                    s = s || x(n.mimeType || d.getResponseHeader("content-type")),
                    e = d.responseText;
                    try {
...
function(t) {
    ...
    t(document).ready(function() {
        var d, m, y, w, g = 0,
        v = 0;
        "MSGesture" in window && (a = new MSGesture, a.target = document.body),
...
function(t, e) {
    ...
    c = n + "transform",
    w[l = n + "transition-property"] = w[h = n + "transition-duration"] = w[d = n + "transition-delay"] = w[p = n + "transition-timing-function"] = w[m = n + "animation-name"] = w[g = n + "animation-duration"] = w[y = n + "animation-delay"] = w[v = n + "animation-timing-function"] = "",
    t.fx = {
    ...
    t.fn.anim = function(n, i, r, o, s) {
        ...
        C = !1;
        if (i === e && (i = t.fx.speeds._default / 1e3), s === e && (s = 0), t.fx.off && (i = 0), "string" == typeof n) u[m] = n,
        u[g] = i + "s",
        u[y] = s + "s",
        u[v] = r || "linear",
        S = t.fx.animationEnd;
            ...
            E && (u[c] = E, b.push(c)),
            i > 0 && "object" == typeof n && (u[l] = b.join(", "), u[h] = i + "s", u[d] = s + "s", u[p] = r || "linear")
        }
        return j = function(e) {
...
function(t, e) {
    function a(n, i, r, o, s) {
        ...
        return o && (a.scale = o, n.css(t.fx.cssPrefix + "transform-origin", "0 0")),
        n.animate(a, i, null, s)
    }
    function u(e, n, i, r) {
        return a(e, n, 0, i,
        function() {
