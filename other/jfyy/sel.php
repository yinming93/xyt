...
<img src="./img/0.jpg" alt="" style="width:100%;">
<p style="font-size: 14px;color:#492100;font-weight:bold;position:absolute;top:15%;left:5%;">
往下滑表格可查看更多排名<br>
</p>

	<div class="sel_main">
<!-- <h2>排行榜查询</h2> -->
	<table border='1' width="100%"cellpadding="2" cellspacing="0" style="color:black;border:1px solid #492100;">
...
<a href="http://szxytang.com/yin/za/jfyy/getcodeurl.php"><img src="an.png" alt="" style="width:36%;position:absolute;top:87%;left:32%;"></a>
</body>
</html>
<!-- 引入脚本 -->
